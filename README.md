...
To have this software work correctly, the sysop must first start an instance of *aprsnws.py* running in the background using the `nohup` command:

`nohup ./aprsnws.py > /tmp/nohup.out &`
